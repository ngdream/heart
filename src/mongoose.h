...
#include <stddef.h>
  ...
  enum
  {
    ...
    MG_EV_HTTP_MSG,   // HTTP request/Httpresponse        struct mg_http_message *
  ...
  {
    struct mg_str method, uri, query, proto;            // Request/Httpresponse line
  ...
  struct mg_http_serve_opts
  {
    ...
    const char *extra_headers; // Extra HTTP headers to add in Httpresponses
